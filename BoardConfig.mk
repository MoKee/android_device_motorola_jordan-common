...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/motorola/jordan-common/bluetooth_bluedroid
...
TARGET_RECOVERY_INITRC := device/motorola/jordan-common/ramdisk/init-recovery.rc
...
BOARD_HARDWARE_CLASS := device/motorola/jordan-common/cmhw/
...
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := build/tools/releasetools/ota_from_target_files --device_specific device/motorola/jordan-common/releasetools/jordan-common_ota_from_target_files.py
...
COMPAT_MODULES:
	...
	make -C device/motorola/jordan-common/modules/backports KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(TARGET_KERNEL_MODULES_TOOLCHAIN) defconfig-mapphone
	make -C device/motorola/jordan-common/modules/backports KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(TARGET_KERNEL_MODULES_TOOLCHAIN)
...
hboot:
	...
	make -C  $(ANDROID_BUILD_TOP)/device/motorola/jordan-common/bootstrap/hboot ARCH=arm CROSS_COMPILE=$(TARGET_KERNEL_MODULES_TOOLCHAIN)
